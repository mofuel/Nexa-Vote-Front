          ...
          <div style={{ ...glassCard, padding: '48px', borderRadius: '16px', boxShadow: '0 24px 64px rgba(0,0,0,0.4)' }}>
            ...
            <div style={{ textAlign: 'center', marginBottom: '32px' }}>
              ...
              <p style={{ color: '#c9c3d9', fontSize: '14px', lineHeight: '20px', maxWidth: '280px', margin: '0 auto' }}>
                Ingrese sus credenciales institucionales para continuar con el proceso de sufragio.
              </p>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              <button
                ...
                style={{
                  ...
                  padding: '16px', borderRadius: '8px', fontWeight: 700,
                  fontSize: '16px', cursor: 'pointer', letterSpacing: '0.03em',
